        ...
        <form action="" id="frmProduct" method="POST" enctype="multipart/form-data">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" name="name" id="name" class="form-control" value="{{$product->name}}" style="width: 100%" placeholder="{{__('Enter product name')}}">
              @if ($errors ->has('name'))
            ...
            <div class="form-group">
              ...
              <input type="file" value="{{$product->avatar}}" name="avatar" class="form-control" id="avatar" placeholder="{{__('Avatar')}}">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" value="{{$product->sku}}" id="sku" name="sku" placeholder="{{__('Enter Sku')}}">
              @if ($errors ->has('sku'))
                <label class="text-danger">
                    {{ $errors -> first('sku')}}
                </label>
            ...
            <div class="form-group">
                ...
                <input type="number" id="stock" name="stock" class="form-control" value="{{$product->stock}}" style="width: 100%" placeholder="{{__('Enter Stock')}}">
                @if ($errors ->has('stock'))
                <label class="text-danger">
                    {{ $errors -> first('stock')}}
                </label>
            ...
            <div class="form-group">
                ...
                <input type="date" id="exprired_at" name="exprired_at" class="form-control" value="{{$product->exprired_at}}" style="width: 100%">
            ...
            <div class="form-group">
              ...
              <input type="number" id="price" name="price" class="form-control" value="{{$product->price}}" style="width: 100%" placeholder="{{__('Enter  Price')}}">
              @if ($errors ->has('price'))
              <label class="text-danger">
                  {{ $errors -> first('price')}}
              </label>
